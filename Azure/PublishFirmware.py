...
# this assumes the existence of a Cosmos Database named "adastorage".
...
container = service.get_container_client("firmware")
if not container.exists():
    container.create_container(public_access="Container")

with open(hexfile, "rb") as data:
    container.upload_blob("TeensyFirmware.TEENSY40.hex", data, overwrite=True)
